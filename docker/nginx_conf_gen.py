...
parser.add_argument("--role", type=str, default='standalone', choices=('standalone', 'master', 'node'),
                    help='The localshare role used to render routing rules.')
...
conf = tpl.render(cert_dir=cert_dir, socket_dir=socket_dir, server_name=args.server_name, role=args.role)
print(conf)
